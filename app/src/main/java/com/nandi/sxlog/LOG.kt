package com.nandi.sxlog

import android.util.Log
import com.nandi.sxlog.handler.*
...
object LOG {
     ...
     */
    @JvmStatic
    fun addCustomerHandler(handler: BaseHandler):LOG {
     ...
     */
    @JvmStatic
    fun addCustomerHandler(handler: BaseHandler,index:Int):LOG {
